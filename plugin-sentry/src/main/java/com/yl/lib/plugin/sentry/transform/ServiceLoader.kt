...
internal fun loadPrivacyClassProxy(project: Project) = newServiceLoader<PrivacyClassTestProxy>(Thread.currentThread().contextClassLoader, Project::class.java).load(project)
